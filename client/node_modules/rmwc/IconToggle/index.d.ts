...
export declare type IconToggleChangeEventDetailT = {
    isOn: boolean;
};
export declare type IconTogglePropsT = {
    /** An onChange callback that receives a custom event. */
    onChange?: (evt: CustomEventT<IconToggleChangeEventDetailT>) => any;
...
export declare const IconToggleRoot: {
...
export declare class IconToggle extends IconToggle_base<IconTogglePropsT> {
    ...
    ripple_: any;
    initialize(): void;
    syncWithProps(nextProps: IconTogglePropsT): void;
    render(): JSX.Element;
}
