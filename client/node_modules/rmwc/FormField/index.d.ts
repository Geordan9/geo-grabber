...
declare type FormFieldRootPropsT = {
    /** Position the input after the label. */
    alignEnd?: boolean;
} & SimpleTagPropsT;
export declare const FormFieldRoot: React.ComponentType<FormFieldRootPropsT>;
...
export declare class FormField extends FormField_base<FormFieldRootPropsT> {
