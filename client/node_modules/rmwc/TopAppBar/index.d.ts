...
export declare const TopAppBarRoot: {
...
declare const TopAppBarSection_base: {
    new <P>(props: any, context?: any): {
        render(): React.ReactElement<any> | null;
        setState<K extends never>(state: {} | ((prevState: Readonly<{}>, props: any) => {} | Pick<{}, K> | null) | Pick<{}, K> | null, callback?: (() => void) | undefined): void;
        forceUpdate(callBack?: (() => void) | undefined): void;
...
export declare class TopAppBarSection extends TopAppBarSection_base<TopAppBarSectionPropsT> {
